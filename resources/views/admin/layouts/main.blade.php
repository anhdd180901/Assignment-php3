...
<head>
  ...
  <title>@yield('title', 'Trang Quan Tri')</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('room.getList') }}" class="nav-link active">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Room
              </p>
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('service.getList') }}" class="nav-link active">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Service
              </p>
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('user.getList') }}" class="nav-link active">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                User
              </p>
